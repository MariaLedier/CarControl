...
export default function ManutencaoVeiculoPage() {
    ...
    const MARCAS_PNEU = [
        ...
        "CONTINENTAL", "DUNLOP", "YOKOHAMA", "HANKOOK", "FIRESTONE", "KUMHO", "MAZZINIECO7", "DURABLE CITY", "HABILEAD", "XBRI"
    ]
    ...
    async function salvar() {
        ...
        try {
            ...
            let resultado
            if (editando) {
                resultado = await apiClient.put("/manutencao", { id: editando.id, ...obj })
            } else {
                resultado = await apiClient.post("/manutencao", obj)
            }
